...
where $$\mathrm{COM}_x(\theta)$$ is the forward position of the center of mass (you should have this function from Assignment 6) relative to the center of the stance foot, and $p_{nsf}(\theta)$ is the (x,y) position of the non-stance (swing) foot relative to the stance foot.
